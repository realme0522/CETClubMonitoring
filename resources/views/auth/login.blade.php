...
<head>
  ...
  <title>CET Club Monitoring Login</title>
  ...
  <!-- icheck bootstrap -->
    <link rel="stylesheet" href="{{ asset('import/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card card-outline card-danger">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>CETSO</b></a>
    </div>
    <div class="card-body">
...
<!-- AdminLTE App -->
<script src="{{ asset('import/dist/js/adminlte.min.js') }}"></script>
</body>
</html>
